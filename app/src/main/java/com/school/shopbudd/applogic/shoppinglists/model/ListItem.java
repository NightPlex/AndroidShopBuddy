...
public class ListItem extends ItemAbstract
{
    ...
    public String getDetailInfo(Context context)
    {
        ...
        if ( !LineUtil.isEmpty(priorityIndex) )
        {
            sb.append(LineUtil.NEW_LINE);
            ...
            sb.append(LineUtil.DETAIL_SEPARATOR);
            sb.append(priority);
        }
        if ( !LineUtil.isEmpty(this.getDeadlineDate()) )
        {
            sb.append(LineUtil.NEW_LINE);
            sb.append(deadLineLabel);
            sb.append(LineUtil.DETAIL_SEPARATOR);
            sb.append(this.getDeadlineDate());
            sb.append(LineUtil.SPACE);
            sb.append(this.getDeadlineTime());
        }
        if ( !LineUtil.isEmpty(this.getReminderCount()) )
        {
            sb.append(LineUtil.NEW_LINE);
        ...
        if ( !LineUtil.isEmpty(this.getNotes()) )
        {
            sb.append(LineUtil.NEW_LINE);
