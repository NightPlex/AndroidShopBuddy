...
import com.school.shopbudd.ui.camera.CameraPreview;
import com.school.shopbudd.ui.product.ProductActivity;
import com.school.shopbudd.utils.CameraUtil;
...
public class CameraActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        productId = (String) extras.get(ProductActivity.PRODUCT_ID_KEY);
        String productName = (String) extras.get(ProductActivity.PRODUCT_NAME);
            ...
            if (!photoConfirmed) {
                ...
                prepareBitmaps(imageData)
                        .doOnNext(bitmap ->
                        {
                            ...
                            CameraUtil.saveBitmap(takenImageBitmap, productImagePath, cameraOrientation).subscribe();
                        })
                        .doOnCompleted(() ->
                        {
    ...
    private Bitmap prepareBitmapsSync(byte[] data) {
        ...
        return CameraUtil.getRotatedBitmap(thumbnailBitmap, cameraOrientation);
    }
    ...
    public Camera getInitializedCamera() {
        ...
        try {
            ...
            int orientation = CameraUtil.getRotationAdjustment(cameraOrientation);
