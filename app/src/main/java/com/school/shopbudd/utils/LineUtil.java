package com.school.shopbudd.utils;
...
public class LineUtil {
    ...
    public static Double getStringAsDouble(String productPrice, String priceFormat2, String priceFormat1, String priceFormat0) {
        ...
        try {
            ...
            stringAsDouble = LineUtil.getStringAsDouble(productPrice, priceFormat2);
        } catch (Exception e1) {
            try {
                stringAsDouble = LineUtil.getStringAsDouble(productPrice, priceFormat1);
            } catch (Exception e2) {
                try {
                    stringAsDouble = LineUtil.getStringAsDouble(productPrice, priceFormat0);
                } catch (Exception e3) {
